...
export class FetchApiImages {
  ...
  getImages(query) {
    const url = `https://pixabay.com/api/?key=30787461-ba0c148aaad98f08ab67703d7&q=${this.query}&page=${this.page}&per_page=40&orientation=horizontal&image_type=photo&safesearch=true`;
